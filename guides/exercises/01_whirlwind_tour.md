# Exercise: A whirlwind tour of Ruby on Rails
...
Then open your site in a web browser by going to [http://localhost:3000/](http://localhost:3000/). You should see Rails' built-in welcome page:
